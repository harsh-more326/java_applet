...
//<applet code = "Boucing_Ball.class" width="1000" height="1000"> </applet>
public class Bouncing_Ball extends Applet
{
  void
  ball (int xmax, int ymax, int r, int x, int y, Graphics g)
  {
  ...
  void
  dda (int x0, int y0, int x1, int y1, int r, Graphics g)
  {
    int dx = x1 - x0;
    int dy = y1 - y0;
    int step;
  ...
  paint (Graphics g)
  {
    ...
    dda (xmax - r - 20, ((ymax - r) / 2), ((xmax - r) / 2), (ymax - r - 50), r,
         g);
  } // function
} // class
